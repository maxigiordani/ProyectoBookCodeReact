...
import { FaUser } from 'react-icons/fa'; // Importar FaUser desde react-icons/fa
import '../../stylesheet/Login.css';

function Login() {
  return (
    <div className="containerlogin mt-5">
      <div className="mb-4 mx-auto" id='card'>
        <h1 className="text-center h2 mt-4">INICIAR SESIÓN</h1>
        <form>
          <div className="card-body">
            ...
            <div className="mb-2 form-check form-check-inline">
              ...
              <label className="form-check-label" htmlFor="recordar">Recordar sesión</label>
            </div>
            <div className="mb-4">
              <button type="submit" className="btn btn-primary botonlogin">Iniciar sesión</button>
              <div className="mt-3 ">
