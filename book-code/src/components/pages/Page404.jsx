        ...
        <>
            <div className="container contenedor-404 mt-3 mb-3">
                <div className="row">
                    ...
                    <div className="col-md-6 col-12 text-center">
                        <img className="img-fluid" id="imagen-astronauta" src="../img/404-removebg.png" alt="error404" />
                    </div>
                </div>
            </div>
            <div className="container contenedor-404 mt-0">
                <div className="row justify-content-center">
                    ...
                    <a className="col-4 col-md-2 mb-2 mb-md-0 btn btn-reg" href="../index.html" role="button">Regresar</a>
                </div>
            </div>
        </>
    )
