        ...
        <div className="col-md-6  mx-auto">
          ...
          <div className='formularios'>
            <Form id="registroForm">
              <Row className="mb-3 formularios">
                <Col>
              ...
              <Form.Group className="mb-3 formularioimput">
                <Form.Label htmlFor="email">Email:</Form.Label>
                <Form.Control className='imputregistro' type="email" id="email" name="email" required minLength="11" maxLength="20" />
              </Form.Group>
              <Form.Group className="mb-3 formularioimput">
                <Form.Label htmlFor="domicilio">Domicilio:</Form.Label>
                <Form.Control className='imputregistro' type="text" id="domicilio" name="domicilio" required minLength="6" maxLength="25" />
              </Form.Group>
              <Row className="mb-3 formularios">
                <Col>
